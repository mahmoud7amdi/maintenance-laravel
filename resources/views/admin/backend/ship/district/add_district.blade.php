    ...
    <div class="row">
        <div class="col-md-9 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br>
                    <form  method="post" action="{{ route('store.district') }}" enctype="multipart/form-data" class="form-horizontal form-label-left">
                        @csrf
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-md-6 col-sm-9 ">
                                <input required type="text"  name="district_name" class="form-control" >
                            </div>
                        </div>
