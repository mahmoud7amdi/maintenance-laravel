    ...
    <div class="row">
        <div class="col-md-9 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br>
                    <form  method="post" action="{{ route('store.category') }}" enctype="multipart/form-data" class="form-horizontal form-label-left">
                        @csrf
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-md-6 col-sm-9 ">
                                <input type="text" required name="category_slug" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-md-6 col-sm-9 ">
                                <input type="file" required  name="category_image" class="form-control" id="image">
                            </div>
                        </div>
